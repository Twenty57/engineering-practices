...
change belong in your codebase, or somewhere else? Does it integrate well with the
...
PR—are individual lines too complex? Are functions too complex? "Too complex" 
usually means **"can't be understood quickly by code
...
complexity in tests just because they aren't part of the main solution.
...
We have [style guides](../../styleguide/linx-style.md) for all
of the major tools we use. Make sure the PR follows the appropriate style guides.
...
READMEs and any related docs. If the PR deletes or deprecates code, consider whether the
documentation should also be deleted. If documentation is missing, ask for it.
...
you can scan over sometimes, but don't scan over a human-written function,
type, or block of code and assume that what's inside of it is okay.
...
and wait for them to clarify it before you try to review it. We hire
...
qualified, particularly for complex issues such as security, concurrency, privacy, etc.
