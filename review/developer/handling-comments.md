...
to help you, the codebase, and our customer, rather than as a personal attack on you
or your abilities.
...
add a code comment that explains why the code is there (this is not currently possible 
in Linx). If a comment seems pointless, only then should your response be an explanation 
...
providing valuable feedback that will help the codebase and the customer. Your first
